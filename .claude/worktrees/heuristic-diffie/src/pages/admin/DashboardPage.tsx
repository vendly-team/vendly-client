...
const DashboardPage = () => {
  ...
  const stats = [
    { label: "Today's Orders", value: todayOrders.length, icon: ShoppingBag, color: 'text-info' },
    { label: "Revenue", value: formatPrice(totalRevenue), icon: DollarSign, color: 'text-success' },
    { label: "Pending Orders", value: pendingOrders.length, icon: Clock, color: 'text-warning' },
    ...
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-card border border-border rounded-lg p-4">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead><tr className="border-b border-border"><th className="text-left py-2 text-muted-foreground font-medium">Order #</th><th className="text-left py-2 text-muted-foreground font-medium">Status</th><th className="text-right py-2 text-muted-foreground font-medium">Total</th></tr></thead>
              <tbody>
        ...
        <div className="bg-card border border-border rounded-lg p-4">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead><tr className="border-b border-border"><th className="text-left py-2 text-muted-foreground font-medium">Product</th><th className="text-left py-2 text-muted-foreground font-medium">SKU</th><th className="text-right py-2 text-muted-foreground font-medium">Stock</th></tr></thead>
              <tbody>
                {lowStock.map((p) => (
