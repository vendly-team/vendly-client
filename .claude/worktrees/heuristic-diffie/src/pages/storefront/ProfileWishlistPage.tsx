...
const ProfileWishlistPage = () => {
  ...
  if (wishlistProducts.length === 0) {
    return (
      <div className="text-center py-20">
        ...
        <Link to="/" className="text-accent hover:underline">Browse Products</Link>
      </div>
    );
  }
  ...
  return (
    <div>
      <h1 className="text-2xl font-display font-bold text-foreground mb-6">Wishlist</h1>
          ...
          <div key={p.id} className="bg-card border border-border rounded-lg overflow-hidden">
            ...
            <div className="p-3">
              ...
              <div className="flex gap-2 mt-2">
                <button onClick={() => { addItem(p); toast.success('Added to cart'); }} className="flex-1 h-9 bg-accent text-accent-foreground rounded-md text-xs font-medium flex items-center justify-center gap-1"><ShoppingCart size={14} /> Add to Cart</button>
